...
public class OrderServiceImpl implements IOrderService {
    ...
    private ShippingVo assembleShippingVo(Shipping shipping){
        ...
        shippingVo.setReceiverPhone(shipping.getReceiverPhone());//shippingVo.?
        return shippingVo;
    }
...
//            校验库存
    ...
    public ServerResponse<String> manageSendsGoods(Long orderNo){
        Order order = orderMapper.selectByOrderNo(orderNo);
        if (order != null){
    ...
    public ServerResponse pay(Long orderNo,Integer userId,String path){
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(PropertiesUtil.getProperty("alipay.callback.url"))//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置(设置授权回调地址，还没有写)
