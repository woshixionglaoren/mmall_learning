...
public class IProductServiceImpl implements IProductService {
    ...
    public ServerResponse<PageInfo> getProductList(int pageNum,int pageSize){
        ...
        List<ProductListVo> productListVoList = Lists.newArrayList();//Lists.newArrayList()和new ArrayList()几乎一模一样, 唯一它帮你做的(其实是javac帮你做的), 就是自动推导尖括号里的数据类型.
    ...
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword,Integer categoryId,int pageNum,int pageSize,String orderBy){
        ...
        if (categoryId != null){
            ...
            categoryIdList = iCategoryService.selectCategoryAndChildrenById(category.getId()).getData();//查询到的商品分类和子分类
        }
